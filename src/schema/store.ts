...
interface MetricConstructorInput {
  id: ID;
  name: String;
...
export class Metric extends AbstractEntity  {
	...
	@Column("String")
	entityId: String
  constructor(data: MetricConstructorInput) {super()}
...
interface TokenDirectoryConstructorInput {
  id: ID;
  chainId: Int;
  contractAddress: String;
  symbol: String;
...
@Entity("TokenDirectory")
export class TokenDirectory extends AbstractEntity  {
	...
	@Column("String")
	source: String
  constructor(data: TokenDirectoryConstructorInput) {super()}
